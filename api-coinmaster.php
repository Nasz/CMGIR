...
class coinmaster{
	...
	private function gettokenfb(){
		$access_tokenfb = [
			'419980425865671|kZlS82Yulk0rCwhZ7fVS0-GBUkA',
	...
	public function addspin($link){
		...
		$getuseridaddlink = $config = $this->Curl("GET", "https://vik-game.moonactive.net/external/users/~".$link."/invite?s=m", false, false, true);
		...
		//เริ่มเล่นเกม
		$accept_invitation = $this->Curl("POST", "https://vik-game.moonactive.net/api/v1/users/".$this->userId."/accept_invitation", $this->headerwhittoken($this->sessionToken), $dataaccept_invitation, true);
